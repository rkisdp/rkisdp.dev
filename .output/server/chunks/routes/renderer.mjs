...
import { p as joinRelativeURL, A as useRuntimeConfig, k as getResponseStatusText, j as getResponseStatus, g as encodePath, b as defineRenderHandler, i as getQuery, c as createError, l as getRouteRules, q as joinURL, z as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1.0"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[{"src":"https://www.googletagmanager.com/gtag/js?id=","async":true},{"children":"\n            window.dataLayer = window.dataLayer || [];\n            function gtag(){dataLayer.push(arguments);}\n            gtag('js', new Date());\n            gtag('config', '');\n          "},{"children":"\n            (function(c,l,a,r,i,t,y){\n              c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};\n              t=l.createElement(r);t.async=1;t.src=\"https://www.clarity.ms/tag/\"+i;\n              y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);\n            })(window, document, \"clarity\", \"script\", '');\n          "}],"noscript":[],"title":"Divya Prakash's Portfolio","htmlAttrs":{"lang":"en"}};
