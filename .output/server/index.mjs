...
import { x as toNodeListener, f as destr, A as useRuntimeConfig, y as trapUnhandledNodeErrors, u as setupGracefulShutdown, z as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
