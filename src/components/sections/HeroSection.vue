<template>
  <section
    class="section relative flex flex-col items-center justify-center overflow-hidden"
  >
    <NebulaBackground :opacity="opacity" :zoomLevel="zoomLevel" />

    <div class="h-full w-full flex flex-col items-center justify-center">
      <div
        class="w-full md:w-[80%] max-w-[900px] z-10 px-4 md:px-0 flex justify-center"
      >
        <h1
