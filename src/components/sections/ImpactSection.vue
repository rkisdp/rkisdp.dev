...
const highlightItems: HighlightItem[] = [
  {
    ...
    description:
      "Creating highly scallable and rock solid system which can handle huge tarrif and data with high availability and reliability.",
    delay: "100ms",
  },
  {
    title: "Optimized and Maintainable Code",
    description:
      "Designing code architechture which is easly maintainable, optimized and naturally understandable.",
    delay: "250ms",
  },
  {
